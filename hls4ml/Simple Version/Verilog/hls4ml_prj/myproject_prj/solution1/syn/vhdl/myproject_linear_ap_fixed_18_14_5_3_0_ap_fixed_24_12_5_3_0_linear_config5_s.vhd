...
entity myproject_linear_ap_fixed_18_14_5_3_0_ap_fixed_24_12_5_3_0_linear_config5_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of myproject_linear_ap_fixed_18_14_5_3_0_ap_fixed_24_12_5_3_0_linear_config5_s is 
...
attribute shreg_extract : string;
    ...
    signal shl_ln_fu_50_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal layer5_out_0_preg : STD_LOGIC_VECTOR (23 downto 0) := "000000000000000000000000";
    signal shl_ln32_1_fu_59_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal layer5_out_1_preg : STD_LOGIC_VECTOR (23 downto 0) := "000000000000000000000000";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                layer5_out_0_preg(10) <= '0';
                layer5_out_0_preg(11) <= '0';
                layer5_out_0_preg(12) <= '0';
                layer5_out_0_preg(13) <= '0';
                layer5_out_0_preg(14) <= '0';
                layer5_out_0_preg(15) <= '0';
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
                                        layer5_out_0_preg(23 downto 8) <= shl_ln_fu_50_p3(23 downto 8);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                layer5_out_1_preg(10) <= '0';
                layer5_out_1_preg(11) <= '0';
                layer5_out_1_preg(12) <= '0';
                layer5_out_1_preg(13) <= '0';
                layer5_out_1_preg(14) <= '0';
                layer5_out_1_preg(15) <= '0';
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
                                        layer5_out_1_preg(23 downto 8) <= shl_ln32_1_fu_59_p3(23 downto 8);
                end if; 
            end if;
        end if;
    end process;

    layer5_out_0_preg(7 downto 0) <= "00000000";
    layer5_out_1_preg(7 downto 0) <= "00000000";
    ...
    layer5_out_0_assign_proc : process(ap_ce, ap_CS_fsm_state1, ap_block_state1, shl_ln_fu_50_p3, layer5_out_0_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
            layer5_out_0 <= shl_ln_fu_50_p3;
        else 
    ...
    layer5_out_0_ap_vld_assign_proc : process(ap_ce, ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
    ...
    layer5_out_1_assign_proc : process(ap_ce, ap_CS_fsm_state1, ap_block_state1, shl_ln32_1_fu_59_p3, layer5_out_1_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
            layer5_out_1 <= shl_ln32_1_fu_59_p3;
        else 
    ...
    layer5_out_1_ap_vld_assign_proc : process(ap_ce, ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = ap_ce))) then 
    ...
    shl_ln32_1_fu_59_p3 <= (p_read1 & ap_const_lv8_0);
    shl_ln_fu_50_p3 <= (p_read & ap_const_lv8_0);
end behav;
